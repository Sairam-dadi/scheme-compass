...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "YojanaMitra — Government Schemes Finder" },
      { property: "og:description", content: "Find every Indian government scheme you qualify for, in one place." },
